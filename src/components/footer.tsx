    ...
    <>
      <footer className="fixed bottom-0 left-0 right-0 z-40 px-4 pb-4">
        <div className="mx-auto max-w-7xl">
          <div className="rounded-2xl bg-black/75 backdrop-blur-sm border border-white/10 px-6 py-4">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    return (
                      <div key={link.label} className="contents">
                        <a
                          ...
                          className="w-8 h-8 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 border border-white/20 text-white transition-colors"
                        ...
                        {isTwitter && (
                          <button
                            ...
                            className="w-12 h-12 flex items-center justify-center rounded-full bg-gradient-to-r from-purple-600 to-blue-600 text-white hover:scale-110 transition-transform shadow-lg shadow-purple-500/50"
              ...
              <div className="flex flex-col items-end gap-2">
                <Link href="#" className="text-white/70 hover:text-white text-xs sm:text-sm transition-colors">
